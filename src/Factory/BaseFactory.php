...
use CakephpFixtureFactories\ORM\FactoryTableLocator;
...
abstract class BaseFactory
{
    ...
    public function __construct()
    {
        ...
        $this->eventCompiler = new EventCollector($this);
    }
    ...
    public function getRepositoryLocator(): AbstractLocator
    {
        return new FactoryTableLocator();
    }
    ...
    public function persist(): EntityInterface|iterable|ResultSetInterface
    {
        ...
        try {
            // Attach listeners if sniffer exists and is instance of EventListenerInterface
            $connection = $this->getTable()->getConnection();
            if (SnifferRegistry::exists($connection->configName())) {
                $sniffer = SnifferRegistry::get($connection->configName());
                if ($sniffer instanceof EventListenerInterface) {
                    $this->getTable()->getEventManager()->on($sniffer);
                }
            }
