...
class DataCompiler
{
     ...
     *
     * @param \App\Test\Factory\BaseFactory $factory Master factory
     */
     ...
     * @param \App\Test\Factory\BaseFactory $factory Collected factory
    ...
    private function getEntityFromDefaultTemplate(): EntityInterface
    {
        ...
        $entityClassName = $this->getFactory()
            ->getTable()
            ->getEntityClass();
    ...
    {
        $count = count($data);
        /** @var \App\Test\Factory\BaseFactory $factory */
    ...
    /**
     * @param \App\Test\Factory\BaseFactory $factory Factory
    ...
    /**
     * @return \App\Test\Factory\BaseFactory
     */
